...
/**
 * Enhanced glow effect system with theme and color preset support
 *
 ...
 * - glowPreset: 'blue' | 'rust' | 'cyan' - Color preset (default: 'blue')
 */
...
export type ColorPreset = 'blue' | 'rust' | 'cyan'
...
const colors = computed(() => colorPresets[preset.value])
