...
export default function TrainingMonitor() {
  ...
  const lossOption: EChartsOption = {
    ...
    legend: { data: [t('training.trainLoss'), t('training.valLoss')], bottom: 10 },
  ...
  const accuracyOption: EChartsOption = {
    ...
    tooltip: { trigger: 'axis' },
    legend: { data: [t('training.trainAcc'), t('training.valAcc')], bottom: 10 },
    grid: { left: '3%', right: '4%', bottom: '15%', containLabel: true },
    xAxis: {
      type: 'category',
      data: metricHistory.epochs,
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (status: string) => {
        ...
        return <Tag color={colorMap[status]}>{t(`training.status_${status}`)}</Tag>
      },
    },
    {
    ...
    },
    {
      ...
      key: 'epoch',
      render: (_: any, record: TrainingJob) => `${record.epoch}/${record.totalEpochs}`,
    },
    {
  ...
  return (
    <div style={{ padding: 24 }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <Space>
          <Badge status={wsConnected ? 'success' : 'error'} text={wsConnected ? t('training.connected') : t('training.disconnected')} />
          {wsConnected ? <WifiOutlined style={{ color: '#52c41a' }} /> : <DisconnectOutlined style={{ color: '#ff4d4f' }} />}
            ...
            children: currentJob ? (
              <>
                  ...
                  <Col span={6}>
                    <Card>
                      <Statistic
                        ...
                        value={metricHistory.learningRate[metricHistory.learningRate.length - 1]}
                        precision={6}
                      />
                    </Card>
                  </Col>
                ...
                <Row gutter={16} style={{ marginBottom: 16 }}>
                  ...
                  <Col span={12}>
                    <Card>
                      <LazyChart option={accuracyOption} style={{ height: 350 }} />
                    </Card>
                  </Col>
                </Row>
                ...
                <Row gutter={16}>
                  <Col span={24}>
                    <Card>
                      <LazyChart option={learningRateOption} style={{ height: 250 }} />
                    </Card>
                  </Col>
                </Row>
              </>
