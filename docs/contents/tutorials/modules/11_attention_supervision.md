...
详见：[注意力机制详细指南](/home/yixian/Projects/med-ml/medfusion/docs/guides/attention/mechanism.md)
...
- [多视图支持](12_multiview_support.md) - 处理多角度医学影像
- [模型导出](13_model_export.md) - 导出训练好的模型
- [生产环境清单](15_production_checklist.md) - 部署前检查

## 参考资源

- [注意力机制详细指南](/home/yixian/Projects/med-ml/medfusion/docs/guides/attention/mechanism.md)
