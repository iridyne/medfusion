...
hero:
  ...
  actions:
    - theme: brand
      text: 从 start 开始
      link: /contents/getting-started/web-ui
    - theme: alt
      text: 跑通 YAML 主线
...
1. [Web UI 快速入门](/contents/getting-started/web-ui)
...
5. [如何新建模型与 YAML](/contents/getting-started/model-creation-paths)
...
3. [高级模式结果回流演示路径](/contents/playbooks/external-demo-path)
4. [结果解读与交付检查](/contents/playbooks/result-interpretation-checklist)
5. [examples/README.md](https://github.com/iridyne/medfusion/blob/main/examples/README.md)
...
- **[Web UI 快速入门](/contents/getting-started/web-ui)** — 从 `medfusion start`、`Getting Started` 和 `Quickstart Run` 理解推荐首跑路径
- **[启动流程与使用工作流（统一口径）](/contents/getting-started/startup-workflow)** — 两条可执行用户路径：标准主线与 ComfyUI 适配线
- **[快速开始](/contents/getting-started/cli-config-workflow)** — 先理解当前最稳定的 YAML + CLI 主链
...
- **[高级模式结果回流演示路径](/contents/playbooks/external-demo-path)** — 用固定脚本演示 “高级模式 -> 训练 -> 结果详情”
- **[结果解读与交付检查](/contents/playbooks/result-interpretation-checklist)** — 用四层口径复盘 summary / metrics / 可视化 / 文件
- **[前端易用性落地手册](/contents/guides/development/frontend-usability-playbook)** — 用统一骨架和验收清单构建简单实用前端
