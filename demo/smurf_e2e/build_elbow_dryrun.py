...
def main() -> None:
    ...
    for i, row in df.iterrows():
        ...
        # build simple non-contiguous sequences per modality
        ...
        # map available numeric columns to demo tabular fields
        ...
        region1_ct_paths = save_seq('region1_ct', [0.08, 0.00, -0.03])
        rows.append(
            {
                'patient_id': pid,
                'age': age,
